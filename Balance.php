...
\Stripe\Stripe::setApiKey(\getenv('test_bIY7tC0VJddLeqIfYY'));
\Stripe\Stripe::setClientId(\getenv('pi_3NVdatGYA51eO9og3xMe3jth'));

<?php
require_once('vendor/autoload.php');
\Stripe\Stripe::setApiKey("test_bIY7tC0VJddLeqIfYY");
echo \Stripe\Balance::retrieve(array("stripe_account" => "pi_3NVdatGYA51eO9og3xMe3jth"));
?>
